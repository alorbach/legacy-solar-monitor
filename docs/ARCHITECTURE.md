...
Developer map of Legacy Solar Monitor. User-facing steps are in [USER-GUIDE.md](USER-GUIDE.md). Adding another inverter is [DEV-add-device.md](DEV-add-device.md). Publisher Drive OAuth is [DEV-google-drive.md](DEV-google-drive.md).
